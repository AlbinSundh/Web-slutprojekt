...
-- Databas: `databas`
--
CREATE DATABASE IF NOT EXISTS `databas` DEFAULT CHARACTER SET utf8 COLLATE utf8_swedish_ci;
USE `databas`;
...
('root', '[{\"db\":\"databas\",\"table\":\"users\"},{\"db\":\"databas\",\"table\":\"posts\"},{\"db\":\"databas\",\"table\":\"Users\"}]');
...
('root', '2021-04-30 08:07:11', '{\"lang\":\"sv\",\"Console\\/Mode\":\"collapse\"}');
